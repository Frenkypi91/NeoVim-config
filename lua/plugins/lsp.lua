-- =============================================================================
-- LSP  (merged: lsp.lua + lsp_completion.lua + julia.lua + cmp.lua)
-- =============================================================================
return {
  ...
  -- --------------------------------------------------------------------------
  {
    ...
    opts = function(_, opts)
      opts.ensure_installed = {
        "pyright", "r-languageserver", "clangd", "rust-analyzer",
        "fortls", "texlab", "html-lsp", "css-lsp", "marksman", "markdownlint",
      }
      return opts
    end,
  },
  ...
  -- --------------------------------------------------------------------------
  -- nvim-lspconfig: server-specific settings (fortls + julials)
  -- --------------------------------------------------------------------------
  {
